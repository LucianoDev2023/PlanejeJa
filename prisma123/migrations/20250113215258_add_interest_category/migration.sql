/*
  ...
  - The values [YIELD] on the enum `TransactionCategory` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TransactionCategory_new" AS ENUM ('HOUSING', 'TRANSPORTATION', 'FOOD', 'ENTERTAINMENT', 'HEALTH', 'INVESTMENT', 'SALARY', 'EDUCATION', 'OTHER', 'INTEREST');
